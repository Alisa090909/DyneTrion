...
def frames_to_atom37_pos(r: Rigid, aatype: torch.Tensor):
    ...
    # 坐标变换：[frame_time, L, 37, 3]
    pred_positions = selected_frames.apply(frame_null_pos)

    # ATOM_MASK_37 shape: [21, 37] -> [frame_time, L, 37, 1]
